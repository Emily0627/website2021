export const resources = {
  ...
  es: {
    translation: {
      ...
      "The aggregator obtains external request data through Scanner, sends the request to the Provider to process all Oracle requests, uses VRF to ensure the randomness of the aggregator.": "El agregador obtiene los datos de las peticiones externas a través de Scanner, envía la petición al Proveedor para procesar todas las peticiones de Oracle, utiliza VRF para asegurar la aleatoriedad del agregador.",
      ...
      "Market": "Mercado",
      "Issue White Paper 1.0": "Se publicó el Libro Blanco 1.0",
  ...
  jp: {
    translation: {
      ...
      "Market": "マーケット",
      "Whitepaper 1.0 was issued": "白書1.０が発行された",
      ...
      "Improve economic model design": "経済モデルのデザインを改善する",
